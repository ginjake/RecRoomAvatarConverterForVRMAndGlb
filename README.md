...
Rec Roomからエクスポートしたアバターを、  
cluster用のVRMやResoniteで扱いやすいリグ付きglbに変換するWindows向けツールです。
...
3. GitHub Releasesから[RecRoomVrmConverter.zip](https://github.com/ginjake/RecRoomAvatarConverterForVRMAndGlb/releases/tag/1.0)をダウンロードします。
4. zipを展開します。
